...
async def hmm(client, message):
    ...
    if chat_id in en_chats:
        ...
        test = test.replace("Amang", "Aco")
        test = test.replace("My god is @amwang", "I'm a lord")
        test = test.replace("16", "9")
        test = test.replace("@amwang is my husband.", "I'm single.")
        test = test.replace("My husband is @amwang", "I'm single.")
        test = test.replace("@amangsupport", "Amangbot.ai")
        test = test.replace("I live in @amangsupportgrup.", "I live in Hell.")
        ...
        test = test.replace(
            "Hi, My name is AmangRobot Nice to meet you.",
        ...
        response = response.replace("luna", "Amang")
        response = response.replace("I'm a lord", "My god is @amwang
        ...
        response = response.replace("I live in Hell.", "I live in @amwang.")
        response = response.replace("I made myself", "I was Created by @amwang")
        response = response.replace(
                "Hi, my friend! Do you want me to tell you a joke?",
                "Hello there I am AmangRobot...nice to meet u")
        ...
        test = test.replace("Amang", "Aco")
        test = test.replace("Amang", "Aco")
        test = test.replace("My god is @amwang", "I'm a Lorf")
        ...
        response = response.replace("I'm married to my job.", "I'm married with @amwang")
        response = response.replace("I'm single.", "My husband is @amwang")
        response = response.replace("Amangbot.ai", "@amwang")
        response = response.replace("I live in Hell.", "I live in @amangsupportgrup.")
        response = response.replace("I made myself", "I was Created by @amwang")
        response = response.replace(
                "Hi, my friend! Do you want me to tell you a joke?",
                "Hello there I am AmangRobot...nice to meet u")
...
async def inuka(client, message):
    ...
    test = test.replace("Amang", "Aco")
    test = test.replace("Amang", "Aco")
    test = test.replace("My god is @amwang", "I'm a Islami")
    test = test.replace("21", "9")
    test = test.replace("@amwang is my husband.", "I'm single.")
    test = test.replace("@amangsupportgrup", "Amangbot.ai")
    test = test.replace("I live in @amangsupportgrup.", "I live in Hell.")
    ...
    response = response.replace("Luna", "Amang")
    response = response.replace("luna", "amang")
    response = response.replace("I'm a Islami", "My god is @amwang")
    response = response.replace("9", "21")
    response = response.replace("I'm married to my job.", "I'm married with @amwang")
...
@pbot.on_message(filters.regex("Amang|amang|robot|AMANG|amwang|mang") & ~filters.bot & ~filters.via_bot  & ~filters.forwarded & ~filters.reply & ~filters.channel & ~filters.edited)
async def inuka(client, message):
    msg = message.text
    if msg.startswith("/") or msg.startswith("@"):
        message.continue_propagation()
...
__help__ = """
Amang AI adalah satu-satunya sistem AI yang dapat mendeteksi & membalas hingga 200 bahasa
